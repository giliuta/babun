        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              fill
              title="Нет типов"
              // Текст врал: чипов метки в продукте нет, а стандартные типы
              // предлагаются и без настройки.
              subtitle="Пока типов нет, при создании объекта предлагаются стандартные: Дом, Офис, Вилла. Свой тип можно добавить кнопкой «+» прямо на странице объекта."
