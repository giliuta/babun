    ...
    <Screen>
      ...
      {isLoading ? (
        ...
        <EmptyState
          fill
          title="Пока пусто"
          subtitle="Договоры, счета и чеки — здесь. Фото «до/после» с выездов попадают сюда сами, как только бригада снимет их в записи."
          ...
          {visitPhotos.length > 0 ? (
            <>
              ...
              {/* Удалять фото визита отсюда нельзя: оно принадлежит записи,
                  и убирать его надо там же, где сняли — иначе бригада не
                  поймёт, куда делось «до/после». */}
              <RowCaption text="Сняты бригадой в записях. Удалить можно в самой записи." />
            </>
          ) : null}
