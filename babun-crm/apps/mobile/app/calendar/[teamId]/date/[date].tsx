...
export default function SpecialDayEditorScreen() {
  ...
  const reset = () => {
    ...
    else router.replace(`/calendar/${teamId}/schedule`);
  };
    ...
    <Screen edges={["top"]}>
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <SectionFooter>
          {override
            ? override.is_working
              ? "В эту дату действуют свои часы, остальные дни живут по недельному графику."
          ...
          <>
            <SectionCard className="mt-6">
              <Pressable
                ...
                accessibilityLabel="Вернуть обычный график"
                style={({ pressed }) => ({
                  minHeight: 48,
                  alignItems: "center",
            ...
            <SectionFooter>
              Особый день исчезнет, и дата снова будет жить по графику недели.
            </SectionFooter>
          </>
        ) : null}
      </ScrollView>
