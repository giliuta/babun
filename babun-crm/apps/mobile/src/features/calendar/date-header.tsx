...
//   выходной     — на месте метки корешком стоит слово «Выходной» (владелец
//                  2026-08-24: «выходной обозначается как метка»). Красный —
//                  тот же, которым шапка красит Сб и Вс: это один и тот же
//                  ответ «в этот день не работаем», сказанный про конкретную
//                  команду. Серый пробовали первым — владелец сразу поймал:
//                  «оно сливается, её вообще не видно». Место одно, и выходной
//                  занимает его первым: «работаем ли» важнее, чем «где».
//
...
export function DateCell({
  ...
  /** У команды на эту дату выходной (график сказал «не работаем»). */
  dayOff?: boolean;
}) {
  ...
  //     выходные, общий ориентир, он не зависит от команды;
    ...
    return (
      ...
      >
        ...
        <View style={{ height: 16, justifyContent: "center" }}>
          {dayOff ? (
            <LabelTag color={t.danger} text="Выходной" lg />
          ) : label ? (
