    ...
    if (!date) {
      router.push({
        ...
        params: {
          ...
          // Бригада, услуги и напоминание ЕДУТ ДАЛЬШЕ вместе с клиентом.
          // Раньше эта ветка забирала только клиента: календарь считал
          // свободное время по бригаде, открытой в чипе, и записывал туда
          // же — клиента, который всегда ездит к бригаде Б, ставили к А.
