...
// открыть закрытый.
//
// СТРАНИЦЫ «ПОРЯДОК СЧЕТОВ» БОЛЬШЕ НЕТ (владелец 2026-09-12: «шесть точек
// справа для передвижения… везде одно и то же»). Отдельный экран ради одного
// жеста был лишней дверью: порядок переставляют ручкой прямо в списке — как
// теги, категории, услуги, метки и типы.
//
