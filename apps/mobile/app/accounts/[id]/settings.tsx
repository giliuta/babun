    ...
    <Screen edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        <RowGroup title="Основное">
          ...
          {/* «ТИП», А НЕ «ВИД» (владелец 2026-09-10). Слово «Вид» закреплено
              за блоком цвета и значка — и до этой правки две соседние строки
              назывались одинаково, отвечая на разные вопросы. */}
          <NavRow
            label="Тип счёта"
            value={kindLabel}
            separated
          ...
          {/* ВИД СЧЁТА — ОДНА СТРОКА И ОДНА ШТОРКА (владелец 2026-09-10:
              ...
              Повторный тап снимает ЗНАЧОК — счёт возвращается к глифу типа.
              Цвет так не снимается: он держит заливку строки (BLOCKS §9.0). */}
          <NavRow
            label="Вид"
            accessory={
