        ...
        <SectionCard className="mt-3" padded>
          <View className="flex-row gap-3">
            ...
            <View className="flex-1">
              ...
              {/* ЧТО ВИДИТ МАСТЕР — ПО ФАКТУ, А НЕ ПО ПАМЯТИ. Здесь стояло
                  «работает только с назначенными заявками», а серверный
                  `list_master_appointments_safe` отдаёт ему И свои заявки, И
                  весь календарь своей команды (`team_id = any(
                  current_user_team_ids())`). Владелец читает эту строку,
                  решая, кого позвать, — она не имеет права быть уже правды. */}
              <Text style={{ marginTop: 3, fontSize: 13, lineHeight: 18, color: t.sub }}>
                ...
                и клиентов, мастер видит календарь своей команды.
              </Text>
            </View>
          </View>
        </SectionCard>
