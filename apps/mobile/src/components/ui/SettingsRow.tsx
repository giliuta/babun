...
export function SettingsRow({
  ...
  sub?: string;
  /** Цвет подписи. Нужен состоянию, которое просит действия, — янтарная
   *  подпись напоминаний устройства (`cabinet/NotificationsRow`): серым это
   *  не сказать. По умолчанию `t.caption`. */
  subColor?: string;
