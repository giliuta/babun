 ...
 *
 *  Нужен там, где платится нижний safe-area отступ: сам `BottomSheet` за свой
 *  проп `footer`, а лист — за собственный подвал, если он его рисует мимо
 *  этого пропа. Клавиатура iOS уже включает зону
