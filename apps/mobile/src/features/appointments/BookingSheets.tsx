  ...
  return (
    ...
    >
      <View style={{ paddingHorizontal: SIDE, paddingBottom: 8 }}>
        {/* «АВТОМАТИЧЕСКИ» — КОМПАКТНОЙ КНОПКОЙ ПО ЦЕНТРУ НАД ЦВЕТАМИ
            (владелец 2026-09-04: «один блок красивый сверху, типа кнопочка
            над цветами, и там написано автоматически — маленькая компактная,
