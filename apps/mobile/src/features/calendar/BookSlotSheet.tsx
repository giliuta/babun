    ...
    >
      {draft ? (
        ...
        >
          ...
          {/* ДВЕ ДОРОГИ СОЗДАНИЯ — ОДНА КНОПКА НА ОБЕ (владелец 2026-09-10:
              «зачем — надо сводить всё к одному, чтобы событие было тоже
              такое же, как клиент»). «Событие» стояло контурной кнопкой
              второго вида, «Клиент» — залитой: сперва они отличались и
              радиусом (999 против 10), а после сведения геометрии осталась
              разная заливка. Владелец выбрал полное совпадение: запись и
              событие равны по весу, и календарь больше не подталкивает к
              одной из дорог.
