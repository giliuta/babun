            ...
            subtitle={
              searching
                ...
                : filter === "invoice"
                  ...
                  : // ПРО «ПО ПРИНЯТОЙ ОПЛАТЕ» ЗДЕСЬ НЕ ГОВОРИМ, ПОКА ТАКОЙ
                    // КНОПКИ НЕТ. Единственная кнопка ведёт в составитель, а
                    // он ЗАВОДИТ НОВЫЙ ПРИХОД: человек, принявший оплату в
                    // записи и поверивший подсказке, записал бы деньги дважды.
