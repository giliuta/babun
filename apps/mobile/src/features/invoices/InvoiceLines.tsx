 ...
 *  Второй формы позиции заводить нельзя (канон «Берём готовое»). */
 ...
 *  «есть услуга — и выбрать уже из услуг, которые у меня добавлены»). Второго
 *  листа каталога в продукте заводить нельзя.
 *
 *  ДОЛГ, НЕ ЭТОГО ЗАХОДА: место этого листа — рядом с самим справочником
 *  (`features/services/`), а не внутри строк счёта; переезд стоит делать
 *  вместе с разделением этого файла, он и так перерос предел. */
