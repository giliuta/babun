...
export async function switchTenant(
  ...
  try {
    ...
    await wipeTenantScopedData({
      ...
      keepLocalCache: true,
      // Компания, КУДА идём: её запросы чистка не выбрасывает, и экран рисует
      // их немедленно, если они уже скачивались. Без этого каждое переключение
      // было холодным на ровном месте — данные были, их стирали, и человек
      // смотрел на скелет, пока летела сеть.
