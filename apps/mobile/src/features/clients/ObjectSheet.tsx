  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ТИП — СВОЕЙ КАРТОЧКОЙ И ПОСЛЕ АДРЕСА: он предзаполнен, его обычно
            не трогают, и держать его выше обязательного поля незачем.
            Шестерёнка словаря остаётся в ряду чипов — там её и завёл владелец
