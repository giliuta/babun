    ...
    >
      ...
      >
        ...
        {/* АДРЕС МОЖНО НЕ СПРАШИВАТЬ ГОЛОСОМ (владелец 2026-09-07: «менеджеру
            ...
            ДВЕРЬ СТОИТ ПОД АДРЕСОМ, А НЕ В КОНЦЕ ЛИСТА (аудит 2026-09-09): она
            нужна ровно в ту секунду, когда адреса нет под рукой, — а стояла
            после заметки, куда до неё ещё надо доскроллить. */}
        {onRequestFromClient ? (
          <RowGroup>
            <ChooseRow
              icon={Send}
