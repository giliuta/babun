...
// ОДНО скругление на прямоугольные поверхности (LOCKED 2026-08-22) и
// отдельное — у главной кнопки (LOCKED 2026-08-27).
//
// `cta: 16` — не произвол и не третье число «просто так». Три причины:
//   1. Владелец 2026-08-27 забраковал капсулу: «менее круглой и немного
//      более квадратные». Пилюля 999 была единственным исключением из
//      закона об одном радиусе, и теперь её на кнопке нет.
//   2. iOS 26 в обратную сторону от «квадратнее» не идёт: Apple радиусы
//      УВЕЛИЧИЛА (секции списков, листы) и ввела концентричные углы.
//      10 на элементе высотой 52 читается индустриально — так рисуют на
//      Android. 16 остаётся щедрым и непрерывным, как у Apple.
//   3. 16 равно гуттеру экрана. Угол кнопки повторяет отступ, в котором
//      она стоит, — это и есть концентричность в нашем масштабе.
//
// Круглые ПО СМЫСЛУ вещи (аватар, точка, чип-пилюля) остаются на `pill`:
// круг не может стать прямоугольником.
