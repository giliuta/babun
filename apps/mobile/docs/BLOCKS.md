...
**Шторка «Итого»** — `src/features/appointments/TotalSheet.tsx`: ОДНА
таблица на общей сетке `TOTAL_GRID` (`src/features/appointments/VatLooks.tsx`):

```
УСЛУГА            КОЛ-ВО     ЦЕНА     СУММА
Refilling         − 3 +       60       180
[Скидка]          10 %      −€18      €162      ← DiscountRow
[VAT]             + 19 %    €30,78              ← VatRow
К оплате                            €192,78     ← DueRow
```

Кол-во, скидка и ставка — один столбец; цена, «−€» и налог — второй; суммы —
третий. Владелец 2026-09-22: «всё красиво столбиками… ровненько».
