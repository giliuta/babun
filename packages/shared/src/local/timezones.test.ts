...
describe("группы часовых поясов", () => {
  ...
  // 63 группы × их города × 365 проб Intl — 4,5 с на ноутбуке и 7 с на
  // раннере CI: штатных 5 с не хватало, и сверка падала «по времени», а не
  // по сути. Порог явный и с запасом.
