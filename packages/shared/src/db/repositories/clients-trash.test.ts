...
//
// Массовые `softDeleteClients` / `restoreClients` здесь СОЗНАТЕЛЬНО не
// проверяются: у них нет ни одного вызова во всём дереве, и тест на них
// закрепил бы мёртвый код вместо продукта.
